...
<?php if ($dataUsers['ERROR']): ?>

    <div class="alert alert-danger">
        <?php echo $dataUsers['ERROR']; ?>
    </div>
...
<?php else: ?>
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <div class="row" id="js-contacts">
            ...
            <?php foreach ($dataUsers as $key => $dataUser): ?>
                ...
                <div class="col-xl-4">
                    <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="oliver kopyov">
                                ...
                                <div class="info-card-text flex-1">
                                    <a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info"
                                       data-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <?php if ($admin || $_SESSION['USER']['id'] == $dataUser['id']): ?>
                                    ...
                                    <span class="text-truncate text-truncate-xl"><?php echo $dataUser['job']; ?></span>
                                </div>
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                <a href="tel:+<?php echo $dataUser['phone']; ?>"
                                   class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mobile-alt text-muted mr-2"></i> +<?php echo $dataUser['phone']; ?>
                                </a>
                                <a href="mailto:<?php echo $dataUser['email']; ?>"
                                   class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mouse-pointer text-muted mr-2"></i>
                                    <?php echo $dataUser['email']; ?></a>
                                <address class="fs-sm fw-400 mt-4 text-muted">
                                    <i class="fas fa-map-pin mr-2"></i> <?php echo $dataUser['address']; ?>
                                </address>
                                <div class="d-flex flex-row">
                                    <?php if ($dataUser['inst']): ?>
                                        <a href="https://www.instagram.com/<?php echo $dataUser['inst']; ?>"
                                    ...
                                    <?php if ($dataUser['vk']): ?>
                                        <a href="https://vk.com/<?php echo $dataUser['vk']; ?>" class="mr-2 fs-xxl"
                                           style="color:#38A1F3">
                                            <i class="fab fa-telegram"></i>
                                        </a>
                                    <?php endif; ?>
                                    <?php if ($dataUser['tg']): ?>
                                        <a href="https://t.me/<?php echo $dataUser['tg']; ?>" class="mr-2 fs-xxl"
                                           style="color:#E1306C">
